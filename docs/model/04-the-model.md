...
The model's architectural components and their elements are detailed in the following sections, starting with [The Definition Layers](./05-definition-layers.md), followed by [The Pivot Point](./06-sensitive-activities.md) examining sensitive activities, and finally [The Measurement Layers](./07-measurement-layers.md).
